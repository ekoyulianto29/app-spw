            ...
            <div class="row justify-content-center">
              <div class="col-md-8">
                ...
                <div class="mb-4 text-center">
                  ...
                  <img src="images/logo.svg" class="img-fluid" style="width: 120px;">
                  <img src="images/logo-vokasi-smk.png" class="img-fluid" style="width: 120px;">
                  <h3 class="mt-4 text-center font-weight-light">LOGIN <span class="text-success">APLIKASI</span> <b class="text-primary">SPW</b> 2021</h3>
                ...
                @endif
                <form class="pt-3"  action="{{ route('loginsiswa') }}" method="post">
                  @csrf
                  <div class="form-group">
                    <input type="text" class="form-control form-control-lg bg-white"placeholder="NISN" name="nisn">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="text-center mt-4 font-weight-light">
                    Belum memiliki akun? <a href="registersiswa" class="text-primary">Registrasi </a>|
